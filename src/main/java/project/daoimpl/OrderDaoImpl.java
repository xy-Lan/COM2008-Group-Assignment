...
public class OrderDaoImpl implements OrderDao{
    ...
    private static final String INSERT_ORDER_SQL = "INSERT INTO orders (user_id, status) VALUES (?, ?);";
    ...
    public void addOrder(Order order) {
        ...
        try (Connection connection = mysqlService.getConnection();
            ...
            preparedStatement.setInt(1, order.getUser().getUserID()); // Assuming the user ID is an integer.
            ...
            try (ResultSet generatedKeys = preparedStatement.getGeneratedKeys()) {
                if (generatedKeys.next()) {
                    order.setOrderNumber(String.valueOf(generatedKeys.getInt(1))); // Assuming the order ID is auto-generated by the database.
                } else {
